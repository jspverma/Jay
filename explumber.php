...
if(isset($_POST['submit1'])){
    ...
    if(empty($_SESSION['name'])) {
        $url="plumber.php";
        // echo "<script>alert('Login First');</script>";
        header('Location:login-sign.php?id='.$id.'&total='.$total.'&qty='.$qtyPro.'&service='.$service.'&date='.$Date.'&time='.$time.'&url='.$url);
    }else{
...
?>
	...
	<head>
		<title> Online plumber services| Best plumber- Hombuilt.com </title>
		<meta name="keywords" content="plumber, plumber in Noida, plumber in gurgaon, plumber in Dehradun, plumber in jaipur, plumber services, plumber near me, plumber in Delhi." />
		<meta name="description" content="Book our services in online Carpentry Services at Home for preeminent rates.  We serve the entire in Delhi, Gurgaon, Jaipur, Mumbai. Hire best plumbers online." />
					...
					<div class="panel-footer" style="border-top: none; padding: 0px 0px;">
						...
						<div class="input-group col-md-4 bootstrap-timepicker timepicker" style="float: left; margin-top: 0px; margin-right: 5px;">
							...
							<select class="form-control ui-timepicker-optionst" name="time">
								<option class="ui-timepicker-am" value="">select time</option>
			...
			<div class="custom_faq_content">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            Ans : Minimum Service charge is 199 Rs for first hour, it will be adjusted in billing amount.

                            <br><br>60 Rs will be charged for next 30 minutes to first 1 Hour.
                            <br><br>50 Rs will be the inspection charges.
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            Ans : •	Trained and certified Carpenters
                            <br> <br>•	Background verified staff
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseSix" class="panel-collapse collapse">
                        <div class="panel-body">
                            Ans : If our service man goes to buy something from your behalf, transportation charges Rs 5o will be applicable + 15 Rs conveyance fees per visit.
                        </div>
                    </div>
                </div>
                <!-- /.panel -->
                <div class="panel panel-default">
                    ...
                    <div id="collapseSeven" class="panel-collapse collapse">
                        <div class="panel-body">
                            Ans : HomBuilt.com provides 15 Day guarantee for the services offered from our service man. 
                        </div>
                    </div>
                </div>
                <!-- /.panel -->
